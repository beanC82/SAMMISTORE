        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SysLog_SysAction_ActionId",
                        column: x => x.ActionId,
                        principalTable: "SysAction",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SysLog_SysFunction_FunctionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConditionValue = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: false),
                    Culture = table.Column<string>(type: "longtext", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    CreatedBy = table.Column<string>(type: "longtext", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VoucherCondition", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VoucherCondition_Voucher_VoucherId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerAddress_Users_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_CustomerAddress_Ward_WardId",
                        column: x => x.WardId,
                        principalTable: "Ward",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FavouriteProduct_Users_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Users",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Message_Users_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_ShippingCompany_ShippingCompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseOrder_Users_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PurchaseOrder_Users_SupplierId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerAddress_WardId",
                table: "CustomerAddress",
                column: "WardId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MyVoucher_CustomerId",
                table: "MyVoucher",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_MyVoucher_VoucherId",
                table: "MyVoucher",
                column: "VoucherId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VoucherCondition_VoucherId",
